...
knn_model = load(open("/workspace/flask-deploy-ml-excercise/src/knn_neighbors-6_algorithm-brute_metric-cosine.sav", "rb"))

total_data = load(open("/workspace/flask-deploy-ml-excercise/src/total_data.sav", "rb"))
